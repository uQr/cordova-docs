...
You may find it useful to fire off a Gulp task every time you do a Cordova build particularly when using a Gulp task to minify your JavaScript code or compile languages like [TypeScript](http://go.microsoft.com/fwlink/?LinkID=533748), [LESS](http://go.microsoft.com/fwlink/?LinkID=533791), or [SASS](http://go.microsoft.com/fwlink/?LinkID=533792). Fortunately, this is quite easy to do via a “before prepare” “hook.” When using the Cordova CLI, you may use [hooks](http://go.microsoft.com/fwlink/?LinkID=533744) to fire off shell or node.js scripts at any number of different points in the build lifecycle. Hooks can cover everything from platform or plugin add to compilation and emulation.
