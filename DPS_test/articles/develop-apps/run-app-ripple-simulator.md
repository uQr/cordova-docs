...
2.  Choose **Android** or **iOS** from the **Solution Platforms** list.
    ...
    ![Select Android as your deployment target](<media/run-ripple-platform-select.png> "Select Android as your deployment target")
...
3.  In the list of target devices, choose one of the Ripple simulators.
    ...
    ![Selecting the Ripple emulator](<media/run-ripple-device-select.png> "Selecting the Ripple emulator")
...
2.  Choose the **Cross Domain Proxy** button, and then choose a proxy.
    ...
    ![Selecting a proxy in the Ripple emulator](<media/run-ripple-proxy-settings.png> "Selecting a proxy in the Ripple emulator")
...
2.  Choose the button that specifies the name of the current device, and then choose a different device.
    ...
    ![Changing the device in Chrome](<run-ripple-change-device.png> "Changing the device in Chrome")
