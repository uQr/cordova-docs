...
![Important settings in the Config Deisgner](https://i-msdn.sec.s-msft.com/dynimg/IC742153.png "Important settings in the Config Deisgner")
...
1.  In Visual Studio, choose <span class="label">Project</span>, <span class="label">Store</span>, <span class="label">Associate App with the Store</span>.
    ...
    ![Associate an app with the Windows Store](https://i-msdn.sec.s-msft.com/dynimg/IC741959.png "Associate an app with the Windows Store")
