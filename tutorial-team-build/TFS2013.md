...
| **Variable**      | **Required For** | **Purpose**                 | **Default Location (Visual Studio 2015)** |
|:------------------|:-----------------|:----------------------------|:------------------------------------------|
| **ANT\_HOME**     | Android in Cordova < 5.0.0  | Location of Ant             | C:\\Program Files (x86)\\Microsoft Visual Studio 14.0\\Apps\\apache-ant-1.9.3 |
...
**Note that Visual Studio 2015 RTM uses the a new remote agent** while VS 2015 RC still uses the legacy vs-mda-remote agent. See [the agent installation documentation](http://go.microsoft.com/fwlink/?LinkID=533745)) for installation details.
...
| VS 2015 **RTM**+ | remoteagent | **iOSRemoteBuildServer** | iOS | URI of the iOS remote agent. Form: <br /> http(s)://&lt;host&gt;:&lt;port&gt;/cordova <br /> Use "https" in secure mode. | https://chux-mini.local:3000/cordova |
| VS 2015 **RTM**+ | remoteagent | **iOSCertificateName** | iOS | Name of the SSL certificate for secure mode. Form: <br /> remotebuild.&lt;host&gt; | remotebuild.chux-mini.local |
