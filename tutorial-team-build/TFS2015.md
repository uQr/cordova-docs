...
**This article is intended for use with TFS 2015 RTM and Visual Studio Online. See [this alternate tutorial](./TFS2015RC/TFS2015.md) for details on using TFS 2015 RC.**
...
When using the Hosted Agent Pool in Visual Studio Online (VSO), all other pre-requisites will already be installed and these environment variables will be set. 
