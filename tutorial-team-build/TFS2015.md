...
Next you will need to install the [cross-platform build agent](http://go.microsoft.com/fwlink/?LinkID=533789) on your server. See [TFS 2015 documentation](http://go.microsoft.com/fwlink/?LinkID=533772) for detailed instructions on configuring the agent with either your on premise TFS 2015 instance or Visual Studio Online. If you want to target iOS, you will need to install this same agent on an OSX machine either on your network or in the cloud using a service like [MacInCloud](http://go.microsoft.com/fwlink/?LinkID=533746).
