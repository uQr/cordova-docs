...
See [Troubleshooting Tips for Building on OSX](http://go.microsoft.com/fwlink/?LinkID=533743) for tips on resolving some common build errors that can occur when building Cordova projects on that operating system.
