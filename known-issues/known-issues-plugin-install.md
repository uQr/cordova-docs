...
This article covers [known issues](../Readme.md#knownissues) related to Visual Studio Tools for Apache Cordova and installing plugins.
...
----------
## More Information
* [Read up on additional known issues](../Readme.md#knownissues)
* [Read up on additional tips, tricks, and tutorials](../Readme.md)
