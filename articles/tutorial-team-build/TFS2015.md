...
<table>
	<thead>
		<tr>
			...
			<td>**Required For**</td>
			<td>**Purpose**</td>
			<td>**Default Location (Visual Studio 2015**</td>
		</tr>
	</thead>
	<tbody>
    <tr>
    ...
    <tr>
      <td>**CORDOVA\_CACHE**</td>
      <td>Optional</td>
      <td>Overrides the default location used by the [sample build module](http://go.microsoft.com/fwlink/?LinkID=533736) to cache installs of multiple versions of Cordova.</td>
